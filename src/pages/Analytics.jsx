...
import { getTransactions, isConfigured } from '../lib/supabase'
import { useToast } from '../hooks/useToast'

const COLORS = ['#7b6fe0','#3dbf82','#e06060','#e09930','#0ea5e9','#8b5cf6','#ec4899','#14b8a6','#f59e0b','#64748b']
...
export default function Analytics() {
  ...
  if (!isConfigured) return (
    <div className="page">
      <div className="empty"><div className="empty-icon">🔑</div>Stel eerst je Supabase credentials in.</div>
    </div>
  )

  if (loading) return (
    <div className="page"><div className="empty"><div className="empty-icon">⏳</div>Laden...</div></div>
  )
            ...
            <div className="chart-wrap">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={data} margin={{ top: 4, right: 4, left: -10, bottom: 0 }}>
                  ...
                  <Bar dataKey="inkomsten" fill="#3dbf82" radius={[4,4,0,0]} />
                  <Bar dataKey="uitgaven"  fill="#e06060" radius={[4,4,0,0]} />
                </BarChart>
              </ResponsiveContainer>
            </div>
          </div>
